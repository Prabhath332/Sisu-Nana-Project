...
namespace web_project.Controllers
{
    public class Users1Controller : Controller
    {
        ...
        public Users1Controller(web_projectContext context)
        {
            _context = context;
        }
        ...
        {
            var web_projectContext = _context.User.Include(u => u.Bank);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,TelephoneNo,FirstName,LastName,UserTypeId,IsActive,Email,Image,Nic,Grade,BankId,Branch,AccountNo,AccountName")] User user)
        {
            ...
            ViewData["BankId"] = new SelectList(_context.Set<Bank>(), "Id", "Id", user.BankId);
            return View(user);
        }
