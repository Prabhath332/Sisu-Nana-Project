...
namespace web_project.Migrations
{
    ...
    [Migration("20211021142120_ChatMessageRelatioship")]
    partial class ChatMessageRelatioship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("web_project.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "24f0171b-3562-451a-b90e-681477c30f21",
                            Email = "admin@outlook.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@outlook.com",
                            NormalizedUserName = "Admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEHGCcMjZClobHyXzAtr38L+OqsqveOu0WsgVw+UXSflrQknlyfgUKNWcZNNX53E7KQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "be9e03f7-b04c-47bf-82a5-7c327cc62ba3",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("web_project.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("web_project.Models.Message", b =>
                {
                    b.HasOne("web_project.Models.AppUser", "Sender")
                        .WithMany("Messages")
                        .HasForeignKey("UserID");
                });
